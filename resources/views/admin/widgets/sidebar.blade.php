            ...
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li class="{{ Request::path()=='admin/management'?'active':''}}">
                        <a href="{{ route('admin.manage') }}"><i class="ti-map-alt"></i> <span>Manage Bill</span></a>
                    </li>

                    <li class="{{ Request::path()=='admin/product'?'active': Request::path()=='admin/product/create'?'active':''  }}">
                    ...
                    <li class="{{ Request::path()=='admin/product-type'?'active': Request::path()=='admin/product-type/create'?'active':'' }}">
