    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li class="{{ Request::path() == 'shop' ? 'active' : '' }}"><a
                        href="{{ route('customer.shop') }}">Shop</a></li>
                <li class="{{ Request::path() == 'cart' ? 'active' : '' }}"><a
                        href="{{ route('customer.cart') }}">Cart</a></li>
                @auth
                    <li class="{{ Request::path() == 'checkout' ? 'active' : '' }}"><a
                            href="{{ route('customer.checkout') }}">Checkout</a></li>
                    <li class="{{ Request::path() == 'history-order' ? 'active' : '' }}"><a
                            href="{{ route('customer.historyOrder') }}">History Order</a></li>
                @endauth
            </ul>
        </nav>
                    ...
                    <nav class="header__menu">
                        <ul>
                            ...
                            @auth
                                ...
                                <li class="{{ Request::path() == 'history-order' ? 'active' : '' }}"><a
                                        href="{{ route('customer.historyOrder') }}">History Order</a>
                                </li>
